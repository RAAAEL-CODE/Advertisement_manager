...
def show_add_event_page():
    with ui.column().classes('max-w-2xl mx-auto rounded-lg shadow-xl w-full mt-24 top-20'):
        ui.label ('CREATE A NEW ADVERT').classes('text-bold mb-6  text-3xl tracking-wider text-center self-center')
